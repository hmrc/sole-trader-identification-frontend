...
import uk.gov.hmrc.soletraderidentificationfrontend.forms.CaptureSautrNewForm
...
import uk.gov.hmrc.soletraderidentificationfrontend.views.html.capture_sautr_new_page
