...
class CaptureOverseasTaxIdentifierCountryControllerISpec extends ComponentSpecHelper
  ...
  "POST /overseas-tax-identifier-country" when {
    "the tax identifiers country is correctly formatted" should {
      "redirect to Check Your Answers" in {
        ...
        lazy val result = post(s"/identify-your-sole-trader-business/$testJourneyId/overseas-tax-identifier-country"
        )("country" -> "GB")
    ...
    "no tax identifier country is submitted" should {
      lazy val result = {
        ...
        stubAuth(OK, successfulAuthResponse())
        post(s"/identify-your-sole-trader-business/$testJourneyId/overseas-tax-identifier-country"
        )("country" -> "")
      }
