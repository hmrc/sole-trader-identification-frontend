...
trait NinoIVStub extends WireMockMethods {
  ...
  def stubCreateNinoIdentityVerificationJourney(nino: String, journeyId: String, journeyConfig: JourneyConfig)(status: Int,
                                                                                                               body: JsObject = Json.obj()
                                                                                                              ): StubMapping =
    internalStubCreateNinoIvJourney(nino          = nino,
                                    journeyId     = journeyId,
                                    journeyConfig = journeyConfig,
                                    uriToPostTo   = "/nino-identity-verification/journey"
                                   )(status, body)

  def stubRetrieveNinoIVResult(journeyId: String)(status: Int, body: JsObject = Json.obj()): StubMapping =
  ...
  def stubCreateNinoIVJourneyFromStub(nino: String, journeyId: String, journeyConfig: JourneyConfig)(status: Int,
                                                                                                     body: JsObject = Json.obj()
                                                                                                    ): StubMapping =
    internalStubCreateNinoIvJourney(
      ...
      journeyId     = journeyId,
      journeyConfig = journeyConfig,
      uriToPostTo   = "/identify-your-sole-trader-business/test-only/nino-identity-verification/journey"
    )(status, body)

  def stubRetrieveNinoIVResultFromStub(journeyId: String)(status: Int, body: JsObject = Json.obj()): StubMapping =
  ...
  private def internalStubCreateNinoIvJourney(nino: String, journeyId: String, journeyConfig: JourneyConfig, uriToPostTo: String)(status: Int,
                                                                                                                                  body: JsObject
                                                                                                                                 ): StubMapping = {
