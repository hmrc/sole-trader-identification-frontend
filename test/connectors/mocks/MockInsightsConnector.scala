...
trait MockInsightsConnector extends MockitoSugar with BeforeAndAfterEach {
  self: Suite =>

  val mockNinoInsightsConnector: NinoInsightsConnector = mock[NinoInsightsConnector]

  override protected def beforeEach(): Unit = {
    super.beforeEach()
    reset(mockNinoInsightsConnector)
  }
